...
id = 1:5000
set.seed(1031); quality = sample(x = 1:5,size = 5000,replace = T,prob = c(0.1,0.15,0.2,0.25,0.3))
set.seed(1031); variety = sample(x = 1:5,size = 5000,replace = T,prob = c(0.1,0.15,0.25,0.25,0.2))
set.seed(1031); price = sample(x = 1:5,size = 5000,replace = T,prob = c(0.1,0.15,0.3,0.25,0.2))
set.seed(1031); distance = sample(x = 1:5,size = 5000,replace = T,prob = c(0.1,0.15,0.2,0.25,0.3))
set.seed(1031); atmosphere = sample(x = 1:5,size = 5000,replace = T,prob = c(0.1,0.2,0.2,0.2,0.3))
set.seed(1031); courteousness = sample(x = 1:5,size = 5000,replace = T,prob = c(0.15,0.2,0.2,0.2,0.25))
